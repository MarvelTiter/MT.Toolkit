...
namespace MT.Toolkit.DataTableExtension
{
    ...
    {
        public static MethodInfo Datarow_getItem = typeof(DataRow).GetMethod("get_Item", [typeof(string)])!;
        public static MethodInfo DataRow_IsNull = typeof(DataRow).GetMethod("IsNull", [typeof(string)])!;
